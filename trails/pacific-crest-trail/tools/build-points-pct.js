...
//
// This tool rebuilt points.json by interpolating the simplified shapefile
...
//
console.error('build-points-pct.js: SUPERSEDED, refusing to run. See the header comment.');
process.exit(1);
